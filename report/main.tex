...
\begin{figure}[!ht]
    ...
    \caption{Convergence study for all four methods when solving \Cref{def:constructed_cos}. The $L^2$ error for all the methods was computed at the final time $T = 1$.}
    \label{fig:conv_cos}
\end{figure}
